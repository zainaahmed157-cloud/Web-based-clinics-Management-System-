...
export default function Herosection() {
    ...
    `}</style>
            <div
                className={` font-cairo container max-w-7xl flex flex-col gap-12 w-full bg-[#f3f7fd] rounded-4xl p-8 md:p-12 lg:p-16 relative overflow-hidden shadow-sm transition-all duration-1000
